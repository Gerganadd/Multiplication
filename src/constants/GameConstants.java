...
{
	public static final int GAME_QUESTIONS = 10;
	
	public static final int MAX_RANDOM_NUMBER = 11;
	
	public static final String FILE_PATH = "src/resources/levels.xml";
	
	public static final String GIRL_LEFT_PICTURE_PATH = "src/resources/child-girl-left.png";
